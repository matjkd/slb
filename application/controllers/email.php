...
//define all input variables
		...
		$data['banker'] = $this->input->post('banker');
		
		$data['assetlendingYesNo'] = $this->input->post('assetlendingYesNo');
		$data['assetlendingLender'] = $this->input->post('assetlendingLender');
		$data['assetlendingAmount'] = $this->input->post('assetlendingAmount');
		
		$data['monthlyIn'] = $this->input->post('monthlyIn');
		$data['monthlyOut'] = $this->input->post('monthlyOut');
		
		$data['CreditorPetition'] = $this->input->post('CreditorPetition');
		$data['WindingUp'] = $this->input->post('WindingUp');
		$data['creditorNames'] = $this->input->post('creditorNames');
		$data['petitioningSolicitor'] = $this->input->post('petitioningSolicitor');
		$data['PetitionReferece'] = $this->input->post('PetitionReferece');
		$data['AmountOfDebt'] = $this->input->post('AmountOfDebt');
...
//pdf 
			...
			$this->load->vars($data);
			$stream = FALSE;
			$pdfcontent = $this->load->view('template/pdf', $data, true);
			$data1 = pdf_create($pdfcontent, 'quote', $stream);
